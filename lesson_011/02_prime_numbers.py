    ...
    def __next__(self):
        while True:
            ...
            for number in self.a:
                ...
                # TODO Вместо подобных сравнений можно использовать словарь
                # TODO действия = {'1': self.is_pal, '2': self.hasthreenines...}
                # TODO Тогда можно будет вместо этго длинного кода написать
                # TODO функция_проверки = действия[self.zfilter]
                # TODO if функция_проверки(): return b
                if self.zfilter == '1':
                    if self.is_pal():
                        return self.b
                elif self.zfilter == '2':
...
# TODO Достаточно будет и такого) хотя конечно можно выбрать что-то поинтереснее при желании
# Часть 3
