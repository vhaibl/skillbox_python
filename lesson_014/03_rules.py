...
print(get_score2(result='Х4/X--------------'))  # TODO Проблема с учетом страйка после спэйра (должно быть 10 + 10)
# TODO Тут должно быть 50
print(get_score2(result='811/X--3/XX171/43'))  # TODO А тут 127
